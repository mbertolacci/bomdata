...
test_that('get_site_raw returns nothing for sites that are not in the return table', {
...
test_that('load_site, site_number variant', run_load_site_test(function(db_connection) {
    load_site(db_connection, site_number = 3003)
}))

test_that('load_site, site_data variant', run_load_site_test(function(db_connection) {
